...
// AssetManagement - Helper endpoints for handling asset uploads.
...
func newAssetManagement(rootSDK *Que, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AssetManagement {
...
func (s *AssetManagement) GetPresignedURL(ctx context.Context, opts ...operations.Option) (*operations.GetPresignedURLResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/assets/presign")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PresignResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PresignResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
